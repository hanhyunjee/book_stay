               ...
               <div class="view-product"> <!-- 상품검색 -->
                  <form name="frmSearch" action="${formAction}" method="get">
						<select id="searchType" name="searchType" style = "width : 120px; height : 30px; margin-right : 0px; ">
							...
							<option value="/bookstay/admin/adminbyTitle">책제목</option> 
							<option value="/bookstay/admin/adminbyCategory">카테고리</option>
							<option value="/bookstay/admin/adminbyWriter">작가</option>
							<option value="/bookstay/admin/adminbyPublisher">출판사</option>
						</select>
						...
						<c:if test= "${searchType == '/bookstay/admin/adminbyTitle'}">
					<h2 class="title text-center">"제목"에대해 "${searchWord }"(으)로 검색한 결과입니다. </h2>
					</c:if>
					<c:if test= "${searchType == '/bookstay/admin/adminbyCategory'}">
					<h2 class="title text-center">"카테고리"에대해 "${searchWord }"(으)로 검색한 결과입니다. </h2>
					</c:if>
					<c:if test= "${searchType == '/bookstay/admin/adminbyWriter'}">
					<h2 class="title text-center">"작가"에대해 "${searchWord }"(으)로 검색한 결과입니다. </h2>
					</c:if>
					<c:if test= "${searchType == '/bookstay/admin/adminbyPublisher'}">
